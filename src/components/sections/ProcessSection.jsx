  ...
  const steps = [
    {
      ...
      description:
        "We are waiting to meet you, be it a request for quotation for a product or partnership.",
      color: "#E6501B",
    },
    {
      id: 2,
      ...
      description:
        "We respond quickly with your quotation/procedure for partnership. We also support you with all relevant facts.",
      color: "#E6501B",
    },
    {
      id: 3,
      ...
      description:
        "For new clients, we often require a commitment fee before delivery. However, for our existing clients, we follow the terms of our contract.",
      color: "#E6501B",
    },
    {
      id: 4,
      ...
      description:
        "At this point, we deliver/supply your products. You often acknowledge receipt. The cycle continues.",
      color: "#E6501B",
    },
  ];
    ...
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            A systematic approach to delivering world-class telecommunication
            solutions.
          </p>
        </motion.div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-4 md:justify-end">
                          ...
                          <h3
                            className={`text-xl font-bold order-1 ${
                    ...
                    >
                      <div
                        className={`w-10 h-10 rounded-full border-4 flex items-center justify-center text-white font-bold ${
                          theme === "dark"
