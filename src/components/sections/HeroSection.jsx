...
const HeroSection = () => {
  ...
  const slides = [
    ...
    {
      id: 3,
      image: 'https://images.unsplash.com/photo-1533664488202-6af66d26c44a?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
            ...
            <div className="relative h-auto min-h-[4rem] sm:min-h-[5rem] lg:min-h-[6rem]">
              <AnimatePresence mode="wait">
                <motion.h1
                  ...
                  animate="visible"
                  exit="exit"
                  className={`absolute text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight ${
