    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {errors.general && (
            <div
              className={`p-3 border rounded-lg text-sm ${isDark ? "bg-red-900/20 border-red-800 text-red-400" : "bg-red-50 border-red-200 text-red-600"}`}
            >
              {errors.general}
            </div>
          )}
          ...
          <div className="flex items-center justify-between">
            <label
              className={`flex items-center gap-2 text-sm cursor-pointer ${isDark ? "text-gray-400" : "text-gray-600"}`}
            >
              <input
                type="checkbox"
                name="remember"
