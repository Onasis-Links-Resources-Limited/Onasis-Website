...
const CategoryProducts = () => {
  ...
  const [filterSubHeading, setFilterSubHeading] = useState(
  ...
  useEffect(() => {
    setFilterSubHeading(searchParams.get("subCategory") || "All");
  }, [searchParams]);
  ...
  const filteredProducts = categoryProducts
    .filter((product) => {
      ...
      const matchesSubHeading =
        filterSubHeading === "All" || product.subHeading === filterSubHeading;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div
          className={`mb-8 rounded-2xl p-5 transition-all duration-300 ${
            theme === "dark"
              ? "bg-[#1a1a1a] border border-[#34404d]"
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-4 py-3 text-sm rounded-xl border-2 transition-all duration-200 focus:outline-none focus:ring-4 ${
                    theme === "dark"
                      ? `bg-[#151515] border-[#34404d] text-white placeholder-gray-400 focus:border-[#E6501B] focus:ring-[#E6501B]/20`
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <button
                ...
                className={`lg:hidden flex items-center gap-2 px-4 py-3 text-sm rounded-xl border-2 transition-all ${
                  theme === "dark"
                    ? "bg-[#151515] border-[#34404d] text-white hover:bg-[#222222]"
              ...
              <div className="relative hidden sm:block">
                ...
                <select
                  ...
                  className={`pl-9 pr-8 py-3 text-sm rounded-xl border-2 appearance-none cursor-pointer transition-all duration-200 focus:outline-none focus:ring-4 ${
                    theme === "dark"
                      ? `bg-[#151515] border-[#34404d] text-white focus:border-[#E6501B] focus:ring-[#E6501B]/20`
              ...
              {/* Divider */}
              <div
                className={`hidden sm:block w-px h-8 ${theme === "dark" ? "bg-[#34404d]" : "bg-gray-200"}`}
              />

              {/* View Toggle */}
              <div className="flex gap-1 rounded-xl border-2 bg-gray-50 p-1 dark:border-[#34404d] dark:bg-[#151515]">
                <button
        ...
        <div className="flex gap-8">
          ...
          <div className="hidden lg:block lg:w-64 lg:flex-shrink-0">
            <ProductSidebar categories={CATEGORIES} activeSlug={slug} />
          </div>
                  ...
                  ([subHeading, products]) => (
                    <div key={subHeading} className="mb-12">
                      ...
                      <div className="relative flex items-center mb-6">
                        <div
                          className={`flex-1 border-t ${theme === "dark" ? "border-[#34404d]" : "border-gray-200"}`}
                        />
                        ...
                        {products.map((product) => (
                            ...
                            className={`group block transition-all duration-300 hover:-translate-y-1 ${
                              viewMode === "grid"
                                ? `rounded-xl overflow-hidden ${
                                    theme === "dark"
                                      ? "bg-[#1a1a1a] hover:bg-[#222222] border border-[#34404d]"
                          ...
                          >
                            <div
                              className={
                                viewMode === "grid"
                                  ? "aspect-[4/3] overflow-hidden bg-[#111111] dark:bg-[#111111]"
                                  : "w-28 h-28 flex-shrink-0 overflow-hidden rounded-lg bg-[#111111] dark:bg-[#111111]"
                              }
                            >
                              <img
                                src={
